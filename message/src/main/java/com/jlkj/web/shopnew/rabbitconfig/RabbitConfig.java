package com.jlkj.web.shopnew.rabbitconfig;
...
public class RabbitConfig {
    ...
    public static final String EXCHANGE_YQS = "exchange_YQS";

    public static final String QUEUE_SMALL_PROGRAM = "QUEUE_SMALL_PROGRAM";
