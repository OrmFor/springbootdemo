package com.jlkj.web.shopnew.common.rabbit;
...
public class YqsRabbitConfig {
    ...
    public static final   String QUEUE_SMALL_PROGRAM = "QUEUE_JINLIE";

    public static final String ROUTINGKEY_SMALL_PROGRAM = "routingKey_SMALL_PROGRAM";
    ...
    public Binding binding() {
        ...
        return BindingBuilder.bind(queueA()).to(defaultExchange()).with(YqsRabbitConfig.ROUTINGKEY_SMALL_PROGRAM);
    }
