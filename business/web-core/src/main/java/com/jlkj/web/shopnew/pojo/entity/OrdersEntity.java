...
public class OrdersEntity extends BaseModelBean {
	...
	private Integer tryInterfaceNum;
    ...
    public Integer getTryInterfaceNum() {
        return tryInterfaceNum;
    }
	public OrdersEntity setTryInterfaceNum(Integer tryInterfaceNum) {
        this.tryInterfaceNum = tryInterfaceNum;
        return this;
    }
    public java.math.BigDecimal getFreightFree() {
        return freightFree;
    }
	public OrdersEntity setFreightFree(java.math.BigDecimal freightFree) {
	...
	public OrdersEntity setSpellId(Integer spellId) {
	...
	public OrdersEntity setAccountType(Integer accountType) {
	...
	public OrdersEntity setIsSpecial(Integer isSpecial) {
